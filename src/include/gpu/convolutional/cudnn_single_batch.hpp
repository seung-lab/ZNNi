...
class cudnn_single_batch_convolutional_layer
...
public:
    ...
    ~cudnn_single_batch_convolutional_layer()
    {
...
public:
    cudnn_single_batch_convolutional_layer( long_t n, long_t fin, long_t fout,
        ...
        , biases(get_device_array<float>(fout))
    {
        ...
        create_tensor_descriptor(&out_desc,1,fout,os[0],os[1],os[2]);
