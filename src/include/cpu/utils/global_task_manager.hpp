...
namespace znn { namespace fwd { namespace details {
...
namespace {
details::global_task_manager_impl& global_task_manager =
    zi::singleton<details::global_task_manager_impl>::instance();
}
