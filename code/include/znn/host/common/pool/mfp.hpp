...
template<typename T>
inline void mfp_inplace_2( T * v, long_t vs,
                           vec3i const & sz,
                           vec3i const & st )
{
...
template<typename T>
inline void mfp_inplace_3( T * v, long_t vs,
                           vec3i const & sz,
                           vec3i const & st )
{
    for ( long_t i = 0, x = 0; i < sz[0]; ++i, x += st[0] )
...
template<typename T>
inline void mfp_inplace_4( T * v, long_t vs,
                           vec3i const & sz,
                           vec3i const & st )
{
    for ( long_t i = 0, x = 0; i < sz[0]; ++i, x += st[0] )
...
template<typename T>
inline void mfp_separation( T const * src,
                            T * dst,
