...
create_multiscale_b1(const vec3i & outsz)
{
  ...
  read_from_file<float>("./0412_VD2D3D-MS/conv4b-p1/filters",conv4b_p3_k,48*60*2*3*3);
  read_from_file<float>("./0412_VD2D3D-MS/nconv4b-p1/biases",conv4b_p3_b,60);
  layers.push_back(std::unique_ptr<device::v1::device_layer>
                    (new device::v1::cudnn_no_precomp_gemm_conv
                     (64, 48, 60,
  ...
  read_from_file<float>("./0412_VD2D3D-MS/conv5a-p1/filters",conv5a_p3_k,60*60*2*3*3);
  read_from_file<float>("./0412_VD2D3D-MS/nconv5a-p1/biases",conv5a_p3_b,60);
  layers.push_back(std::unique_ptr<device::v1::device_layer>
                    (new device::v1::cudnn_no_precomp_gemm_conv
                     (64, 60, 60,
  ...
  read_from_file<float>("./0412_VD2D3D-MS/conv5b-p1/filters",conv5b_p3_k,60*60*2*3*3);
  read_from_file<float>("./0412_VD2D3D-MS/nconv5b-p1/biases",conv5b_p3_b,60);
  layers.push_back(std::unique_ptr<device::v1::device_layer>
                    (new device::v1::cudnn_no_precomp_gemm_conv
                     (64, 60, 60,
...
// convx
  ...
  read_from_file<float>("./0412_VD2D3D-MS/convx_p3/filters",convx_k,60*200*1*1*1);
  read_from_file<float>("./0412_VD2D3D-MS/nconvx_p3/biases",convx_b,200);
  layers.push_back(std::unique_ptr<device::v1::device_layer>
                   (new device::v1::cudnn_no_precomp_gemm_conv
                    (64, 60, 200,
