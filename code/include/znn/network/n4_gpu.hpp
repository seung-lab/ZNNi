...
#include "znn/device/v1/mfp.hpp"
#include "znn/device/v1/fft_conv.hpp"
#include "znn/device/v1/dp_fft_conv.hpp"
#include "znn/device/v1/fft_conv.hpp"
...
create_n4(const vec3i outsz)
{
  ...
  layers.push_back(std::unique_ptr<device::v1::device_layer>
                   (new device::v1::maxout(4, 48, 2, vec3i(1,46,46)+outsz-vec3i(1,1,1))));
