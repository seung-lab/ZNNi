...
// RUN THE FOLLOWING
// ./bin/benchmark_fusion_a m56 4 4
// ./bin/benchmark_fusion_a m56 4 4
                               ...
                               std::ofstream & rout )
{
    ...
    try
    {
        device::fusion::network<device::fusion::fft_it> net(nd,cuttoff,callback);
...
void benchmark( std::string const & rep, long_t rounds )
{
    ...
    std::string report_path = "../reports/" + net_name + ".fusion_a." + rep + ".report";
