...
\section{Introduction}
  ...
  segmentation~\cite{turaga2010convolutional, ciresan2012deep}, object
  detection and localization~\cite{sermanet2013overfeat}, and are
  generally useful for image to image transformations.
  ...
  available ones are the Caffe implementation of
  \cite{tschopp2015efficient}, ZNN \cite{zlateski2015znn}, and
