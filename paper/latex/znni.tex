...
\subsection{Maximizing throughput}
  ...
  The fact that $S=1$ produces better results is more surprising, and we attempt to give some theoretical intuition here.
...
\subsection{GPU + host RAM convolutional layer}
  ...
  Fig.~\ref{fig:partial_execa} can be decomposed into 4 sub--layers
