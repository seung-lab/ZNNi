...
K.~Chellapilla, S.~Puri, and P.~Simard, ``High performance convolutional neural
  networks for document processing,'' in \emph{Tenth International Workshop on
  Frontiers in Handwriting Recognition}.\hskip 1em plus 0.5em minus 0.4em\relax
  Suvisoft, 2006.

\bibitem{scherer2010accelerating}
D.~Scherer, H.~Schulz, and S.~Behnke, ``Accelerating large-scale convolutional
  neural networks with parallel graphics multiprocessors,'' in \emph{Artificial
  Neural Networks--ICANN 2010}.\hskip 1em plus 0.5em minus 0.4em\relax
  Springer, 2010, pp. 82--91.

\bibitem{strigl2010performance}
D.~Strigl, K.~Kofler, and S.~Podlipnig, ``Performance and scalability of
  gpu-based convolutional neural networks,'' in \emph{2010 18th Euromicro
  Conference on Parallel, Distributed and Network-based Processing}.\hskip 1em
  plus 0.5em minus 0.4em\relax IEEE, 2010, pp. 317--324.
...
D.~C. Ciresan, U.~Meier, J.~Masci, L.~Maria~Gambardella, and J.~Schmidhuber,
  ...
  on Artificial Intelligence}, vol.~22, no.~1, 2011, p. 1237.

\bibitem{MeekerReport14}
M.~Meeker, ``Internet trends 2014,''
  \url{http://www.kpcb.com/blog/2014-internet-trends}, 2014 (accessed April 9,
  2016).

\bibitem{ReelSEO}
``Youtube changes at a rate of 33\% a year.''

\bibitem{Lichtman2014big}
J.~W. Lichtman, H.~Pfister, and N.~Shavit, ``The big data challenges of
  connectomics,'' \emph{Nature neuroscience}, vol.~17, no.~11, pp. 1448--1454,
  2014.

\bibitem{mathieu-iclr-14}
M.~Mathieu, M.~Henaff, and Y.~LeCun, ``Fast training of convolutional networks
  through ffts,'' in \emph{International Conference on Learning Representations
  (ICLR2014)}.\hskip 1em plus 0.5em minus 0.4em\relax CBLS, April 2014.

\bibitem{vasilache2014fast}
N.~Vasilache, J.~Johnson, M.~Mathieu, S.~Chintala, S.~Piantino, and Y.~LeCun,
  ``Fast convolutional nets with fbfft: A gpu performance evaluation,''
  \emph{arXiv preprint arXiv:1412.7580}, 2014.

\bibitem{zlateski2015znn}
A.~Zlateski, K.~Lee, and H.~S. Seung, ``Znn-a fast and scalable algorithm for
  ...
  machines,'' \emph{arXiv preprint arXiv:1510.06706}, 2015.

\bibitem{tschopp2015efficient}
F.~Tschopp, ``Efficient convolutional neural networks for pixelwise
  classification on heterogeneous hardware systems,'' \emph{arXiv preprint
  arXiv:1509.03371}, 2015.

\bibitem{ELEKTRONN2015}
\BIBentryALTinterwordspacing
M.~P. I. F.~M. Research. (2015) {ELEKTRONN} a neural network toolkit. [Online].
  Available: \url{http://elektronn.org/}
\BIBentrySTDinterwordspacing

\bibitem{matan1991multi}
O.~Matan, C.~J. Burges, Y.~LeCun, and J.~S. Denker, ``Multi-digit recognition
  using a space displacement neural network,'' in \emph{NIPS}.\hskip 1em plus
  0.5em minus 0.4em\relax Citeseer, 1991, pp. 488--495.
...
\bibitem{ning2005toward}
F.~Ning, D.~Delhomme, Y.~LeCun, F.~Piano, L.~Bottou, and P.~E. Barbano,
  ``Toward automatic phenotyping of developing embryos from videos,''
  \emph{Image Processing, IEEE Transactions on}, vol.~14, no.~9, pp.
  1360--1371, 2005.

\bibitem{giusti2013fast}
A.~Giusti, D.~C. Cire{\c{s}}an, J.~Masci, L.~M. Gambardella, and
  J.~Schmidhuber, ``Fast image scanning with deep max-pooling convolutional
  neural networks,'' \emph{arXiv preprint arXiv:1302.1700}, 2013.

\bibitem{masci2013fast}
J.~Masci, A.~Giusti, D.~Ciresan, G.~Fricout, and J.~Schmidhuber, ``A fast
  learning algorithm for image segmentation with max-pooling convolutional
  networks,'' in \emph{Image Processing (ICIP), 2013 20th IEEE International
...
J.~Long, E.~Shelhamer, and T.~Darrell, ``Fully convolutional networks for
  semantic segmentation,'' in \emph{The IEEE Conference on Computer Vision and
  Pattern Recognition (CVPR)}, June 2015.

\bibitem{frigo1999fftw}
M.~Frigo and S.~G. Johnson, ``Fftw user’s manual,'' \emph{Massachusetts
...
------, ``Fftw: An adaptive software architecture for the fft,'' in
  ...
  IEEE International Conference on}, vol.~3.\hskip 1em plus 0.5em minus
  0.4em\relax IEEE, 1998, pp. 1381--1384.

\bibitem{nvidia2010cufft}
C.~Nvidia, ``Cufft library,'' 2010.

\bibitem{warren2013hacker}
H.~S. Warren, \emph{Hacker's delight}.\hskip 1em plus 0.5em minus 0.4em\relax
  Pearson Education, 2013.

\bibitem{bell2011thrust}
N.~Bell and J.~Hoberock, ``Thrust: A 2 6,'' \emph{GPU Computing Gems Jade
  Edition}, p. 359, 2011.
