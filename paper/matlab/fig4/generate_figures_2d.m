...
[a,b1,s1] = load_data_6('../data/aws8_2d.txt');
[~,b2,s2] = load_data_6('../data/aws18_2d.txt');
[~,b3,s3] = load_data_6('../data/intel40_2d.txt');
[~,b4,s4] = load_data_6('../data/phi_2d.txt');
...
% for k = 80:20:120
% 
%     b1 = load_data_raw_speed('../data/aws8_2d.txt', k);
%     b2 = load_data_raw_speed('../data/aws18_2d.txt', k);
%     b3 = load_data_raw_speed('../data/intel40_2d.txt', k);
%     b4 = load_data_raw_speed('../data/phi_2d.txt', k);
% 
